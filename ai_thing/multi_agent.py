...
async def entrypoint(ctx: JobContext):
    ...
    session = AgentSession[StoryData](
        ...
        llm=openai.LLM(model="gpt-4o-mini", api_key="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"),
